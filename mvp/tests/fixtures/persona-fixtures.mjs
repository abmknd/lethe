...
export function buildLeilaAhmadi(overrides = {}) {
  return {
    ...
    preferences: {
      ...
      matchIntent: ['peer exchange', 'collaboration'],
      offers: ['organizational development frameworks', 'qualitative research methods'],
      asks: ['qual research in social impact', 'researchers in organizational behavior'],
      interests: ['organizational development', 'change management', 'social impact'],
      objectives: [],
...
export function buildMeiChen(overrides = {}) {
  return {
    ...
    preferences: {
      ...
      offers: ['user research support', 'saas product feedback'],
      asks: ['senior product mentor', 'startup strategy'],
      interests: ['product', 'ux', 'growth'],
      objectives: [],
