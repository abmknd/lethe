...
export function Step9FinishRegistration({ isActive, direction, onContinueToVerify }: Step9Props) {
  ...
  return (
    <div className={`kyc-step ${getClassName()}`}>
      ...
      <h1 className="font-['Libre_Franklin'] text-[clamp(28px,4vw,40px)] font-light italic leading-[1.15] tracking-[-0.02em] text-white/90 mb-10">
        Finish your<br />
      ...
      {/* Why connect section */}
      <div className="mb-8">
        <h2 className="font-['Libre_Franklin'] text-[18px] font-normal text-white/90 mb-4 text-center">
