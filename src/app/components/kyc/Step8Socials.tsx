    ...
    <div className={`kyc-step ${getClassName()}`}>
      ...
      <div className="flex flex-col gap-[10px]">
        ...
        <div className="flex items-center gap-3 bg-white/[0.08] border border-white/[0.07] rounded-xl px-4 py-[14px] focus-within:border-[#7FFF00]/30 transition-colors">
          ...
          <span className="font-['Libre_Franklin'] text-[10px] tracking-[0.14em] uppercase text-white/30 w-[72px] flex-shrink-0">
            LinkedIn
          </span>
          <input
            type="text"
            ...
            className="flex-1 bg-transparent border-none outline-none font-['Libre_Franklin'] text-[12px] tracking-[0.04em] text-white/90 placeholder:text-white/[0.12]"
          />
        </div>
      ...
      <p className="font-['Libre_Franklin'] text-[10px] tracking-[0.12em] text-white/30 text-center leading-[1.7] mt-4">
