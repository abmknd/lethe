    ...
    <>
      <style>{`
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .relethe-signup-form button { font-family:var(--mono); font-size:11px; letter-spacing:.3em; text-transform:uppercase; color:#6B6B6B; background:transparent; border:none; border-radius:22px; padding:12px 32px 12px 20px; cursor:none; transition:all .3s; white-space:nowrap; display:flex; align-items:center; gap:8px; flex-shrink:0; }
      ...
      <nav className="relethe-nav">
        ...
        <div className="relethe-nav-links">
          ...
          <button
            onClick={() => {
              document.getElementById('relethe-diagnostic')?.scrollIntoView({ behavior: 'smooth' });
            }}
      ...
      <section id="relethe-demo">
        ...
        <div className="relethe-demo-wrap relethe-reveal" ref={demoWrapRef}>
          <div className="relethe-demo-card">
            ...
            >
              <source
                src="https://dlcdg6ffbxtdlves.public.blob.vercel-storage.com/lethe-showcase.mp4"
                type="video/mp4"
              />
            </video>
          </div>
