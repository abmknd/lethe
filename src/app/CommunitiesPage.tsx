    ...
    <div className="min-h-screen bg-[#050705] text-white/88 flex flex-col">
      ...
      <nav className="h-14 flex items-center justify-between px-8 bg-[#000000] border-b border-[#1a1a1a] flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div className="font-['Libre_Franklin'] text-[14px] font-normal text-white tracking-[0.3em] uppercase leading-[1.4]">
            RELETHE
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-12 py-5" style={{ scrollbarWidth: 'none' }}>
        {activeTab === 'my' ? (
          <>
            {/* Page Header */}
            <div className="mb-7">
              <h1 className="font-['Libre_Franklin'] text-[26px] font-normal italic text-white/88 mb-[6px]">
                Your communities
              </h1>
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pt-4 flex flex-col flex-1">
        ...
        <h3 className="font-['Libre_Franklin'] text-[16px] font-normal text-white/88 mb-[5px] leading-[1.3]">
          {community.name}
        </h3>
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-[3px]">
          <h3 className="font-['Libre_Franklin'] text-[15px] font-normal text-white/88">
            {community.name}
          </h3>
...
function EmptyState({ type }: { type: 'my' | 'invites' }) {
  return (
    <div className="flex flex-col items-center justify-center p-20 text-center border border-white/[0.07] rounded-2xl bg-[#0b0e0b]">
      ...
      <h3 className="font-['Libre_Franklin'] text-[18px] italic font-normal text-white/88 mb-2">
