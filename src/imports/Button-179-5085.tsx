...
export default function Button() {
  return (
    <div className="relative size-full" data-name="button">
      <Div />
      <p className="-translate-x-1/2 absolute font-['Cormorant_Garamond'] leading-[20px] left-[66px] not-italic text-[14px] text-[rgba(255,255,255,0.5)] text-center top-[-1.2px] tracking-[4.2px] uppercase whitespace-nowrap">RELETHE</p>
    </div>
  );
}